...
![MCU Dynamic Binary Instrumentation ](/assets/chip-peripheral-forwarding/intro.png)
...
![dbi arch](/assets/chip-peripheral-forwarding/dbi.png)
...
![PinTool](/assets/chip-peripheral-forwarding/pin.png)
...
![c lang to asm](/assets/chip-peripheral-forwarding/c-asm.png)
...
![various SDKs](/assets/chip-peripheral-forwarding/sdks.png)
...
![Asan insert function](/assets/chip-peripheral-forwarding/adin.png)
...
![STM32L0 memory map](/assets/chip-peripheral-forwarding/memory_map.png)
...
![debugger and MCU board](/assets/chip-peripheral-forwarding/debugger.png)
...
![Raspberry and MCU](/assets/chip-peripheral-forwarding/raspberry.png)
...
![connect MCU to debugger](/assets/chip-peripheral-forwarding/connect.png)

1. Run OpenOCD or GDB server:
![GDB Jlink server](/assets/chip-peripheral-forwarding/ocd_gdb.png)
...
![https://github.com/remotemcu/remcu_examples/raw/master/stm32f4_discovery/accell_graph/assets/mems_demo.gif](https://github.com/remotemcu/remcu_examples/raw/master/stm32f4_discovery/accell_graph/assets/mems_demo.gif)
